export const en = {
  ...
  settings: {
    ...
    reminderIntervalDialogSectionInterval: 'Interval',
    reminderIntervalDialogSectionWeekday: 'Weekday',
    reminderIntervalDialogSectionHour: 'Hour',
    reminderIntervalDialogSectionMinute: 'Minute',
    reminderIntervalDialogSectionDayOfMonth: 'Day of month',
    reminderIntervalDialogSectionDayOfMonthHint: 'Must be between 1 and 31',
    reminderIntervalDialogSectionMonth: 'Month',
